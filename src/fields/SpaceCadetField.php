...
namespace theskyfloor\spacecadet\fields;

use theskyfloor\spacecadet\SpaceCadet;
use theskyfloor\spacecadet\assetbundles\spacecadetfieldfield\SpaceCadetFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SpaceCadetField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('space-cadet', 'SpaceCadetField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'space-cadet/_components/fields/SpaceCadetField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SpaceCadetFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SpaceCadetSpaceCadetField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'space-cadet/_components/fields/SpaceCadetField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
